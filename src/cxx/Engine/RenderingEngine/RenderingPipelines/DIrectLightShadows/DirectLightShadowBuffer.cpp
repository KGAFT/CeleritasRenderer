...
void RenderEngine::DirectLightShadowBuffer::recalculateMatrixForLightSource(glm::vec3 lightPos, int maxLightShadowDistance)
{
...
RenderEngine::LightViewData &RenderEngine::DirectLightShadowBuffer::getViewData()
{
    return viewData;
}